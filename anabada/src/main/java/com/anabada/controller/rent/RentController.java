...
public class RentController {
	...
	public String rentalBoard(
			@RequestParam(name = "page", defaultValue = "1") int page, String type, String searchWord,
	...
	public String rentalBoardRead(
			...
			@RequestParam(name = "page", defaultValue = "1") int page, @AuthenticationPrincipal UserDetails userDetails,
			Model model) {
		UserDTO user = lservice.findUser(userDetails.getUsername());

		model.addAttribute("user", user);
		PageNavigator navi = service.getPageNavigator(pagePerGroup, countPerPage, page, null, null);
